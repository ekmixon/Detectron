...
def add_fpn_retinanet_outputs(model, blobs_in, dim_in, spatial_scales):
            ...
            for nconv in range(cfg.RETINANET.NUM_CONVS):
                ...
                if lvl == k_min:
                    ...
                    bl_out = model.ConvShared(
                        ...
                        stride=1,
                        pad=1,
                        weight=f'retnet_bbox_conv_n{nconv}_fpn{k_min}_w',
                        bias=f'retnet_bbox_conv_n{nconv}_fpn{k_min}_b',
                    )
    ...
    for i, lvl in enumerate(range(k_min, k_max + 1)):
        bbox_pred = f'retnet_bbox_pred_fpn{lvl}'
        ...
        if lvl == k_min:
            ...
            model.ConvShared(
                ...
                pad=1,
                stride=1,
                weight=f'retnet_bbox_pred_fpn{k_min}_w',
